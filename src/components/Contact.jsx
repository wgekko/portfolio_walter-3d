...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Walter Portfolio",
          from_email: form.email,
          to_email: "waltergomez75@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Gracias. te contactaremos lo más pronto posible...");
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Para poder comunicarnos</p>
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="Cúal es tu dirección de correo?"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
